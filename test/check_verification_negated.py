...
beta_neg = parse_g2(beta_neg_hex) # Try negating?
gamma_neg = parse_g2(gamma_neg_hex)
delta_neg = parse_g2(delta_neg_hex)

# Negate VK points
beta_neg = bn128_curve.neg(beta_neg)
gamma_neg = bn128_curve.neg(gamma_neg)
delta_neg = bn128_curve.neg(delta_neg)
...
print("Computing Miller Loops (Negated VK)...")
