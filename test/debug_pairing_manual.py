...
print(f"A on curve? {bn128_curve.is_on_curve(A, bn128_curve.b)}")
print(f"B on curve? {bn128_curve.is_on_curve(B, bn128_curve.b2)}")
print(f"C on curve? {bn128_curve.is_on_curve(C, bn128_curve.b)}")
print(f"alpha on curve? {bn128_curve.is_on_curve(alpha, bn128_curve.b)}")
print(f"beta_neg on curve? {bn128_curve.is_on_curve(beta_neg, bn128_curve.b2)}")
print(f"gamma_neg on curve? {bn128_curve.is_on_curve(gamma_neg, bn128_curve.b2)}")
print(f"delta_neg on curve? {bn128_curve.is_on_curve(delta_neg, bn128_curve.b2)}")
print(f"L on curve? {bn128_curve.is_on_curve(L, bn128_curve.b)}")
