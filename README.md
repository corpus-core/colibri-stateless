...
ETH2.0 Spec Version 1.4.0
License
[npm](https://www.npmjs.com/package/@corpus-core/colibri-stateless)
...
**Docker / Prover Server** (run your own prover)
...
This project (everything *except* `src/server/`) is licensed under the MIT License. See [LICENSE](LICENSE) for details.
