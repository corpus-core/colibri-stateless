...
//
// A global array with default visibility is an exported symbol of the dynamic
// framework. The linker treats exported symbols as roots for dead-code stripping
// and will never remove them -- nor the static archive objects they reference.
