...
# Generate test_config.swift for integration tests (like emscripten test_config.js)
echo "📝 Generiere test_config.swift für Integration Tests..."
TEST_CONFIG_FILE="$SWIFT_DIR/test_config.swift"
TEST_DATA_PATH="$ROOT_DIR/test/data"

cat > "$TEST_CONFIG_FILE" << EOF
// Generated by build_macos.sh. Do not edit manually.
// This file is used by integration tests to find test data directory.
let testDataPath = "$TEST_DATA_PATH"
EOF

echo "✅ test_config.swift erstellt: $TEST_CONFIG_FILE"